  ...
  return (
    <div className="min-h-screen p-4 md:p-6 lg:p-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">On-Campus Properties</h1>
          <p className="text-gray-600">Student accommodation with shared facilities</p>
        </div>
        <Link
          href="/dashboard/properties/add-on-campus"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        <StatsCard title="Total Properties" value={stats.total} icon={Building2} color="blue" />
        <StatsCard title="Available" value={stats.available} icon={Building2} color="green" />
        <StatsCard title="Occupied" value={stats.occupied} icon={Building2} color="purple" />
        <StatsCard title="Maintenance" value={stats.maintenance} icon={Building2} color="yellow" />
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {filteredProperties.map((property: any) => (
            ...
            >
              ...
              <div className="p-5">
                <Link href={`/dashboard/properties/${property.id}`}>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 cursor-pointer group-hover:text-blue-600 transition-colors line-clamp-1">
                    {property.name}
                  </h3>
                </Link>
