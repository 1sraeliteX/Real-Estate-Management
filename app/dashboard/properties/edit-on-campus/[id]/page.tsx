...
export default function EditOnCampusPropertyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateProperty.mutateAsync({ id: propertyId, data: updatedProperty })
      router.push('/dashboard/properties/on-campus')
    } catch (error) {
  ...
  useEffect(() => {
    if (property) {
      setFormData({
        ...
        type: property.type || 'lodge',
        numberOfRooms: property.numberOfRooms?.toString() || '',
        numberOfBathrooms: property.numberOfBathrooms?.toString() || '',
        numberOfKitchens: property.numberOfKitchens?.toString() || '',
        yearlyRent: property.yearlyRent?.toString() || '',
        description: property.description || '',
        amenities: property.amenities || [],
        images: Array.isArray(property.images) ? property.images : [],
        waterAvailability: property.waterAvailability || 'in-building',
      })
    }
  }, [property])
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Edit On-Campus Property</h1>
          ...
          {isLoading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormData({ ...formData, waterAvailability: e.target.value as 'in-building' | 'in-compound' })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
            ...
            <div className="text-center py-8">
              ...
              <Link href="/dashboard/properties/on-campus" className="text-blue-600 hover:text-blue-700">
                Back to On-Campus Properties
              </Link>
            </div>
          )}
        </div>
