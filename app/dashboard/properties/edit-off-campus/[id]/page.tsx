...
export default function EditOffCampusPropertyPage() {
  ...
  useEffect(() => {
    if (property) {
      setFormData({
        ...
        kitchens: property.numberOfKitchens?.toString() || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/dashboard/properties/off-campus')
    } catch (error) {
  ...
  if (!property) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/dashboard/properties/off-campus" className="text-purple-600 hover:text-purple-700">
          Back to Properties
        </Link>
      </div>
    )
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-6">
        <Link
          href="/dashboard/properties/off-campus"
          className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-4"
        >
          <ArrowLeft className="w-4 h-4" />
          Back to Off-Campus Properties
        </Link>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Edit Off-Campus Property</h1>
